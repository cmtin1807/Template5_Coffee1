                    ...
                    if (!v) {
                        ...
                        (v = k(e, (i = h,
                            ...
                            c = function(e, t, n, a, c) {
                                var f, h, v, y = 0, m = "0", x = e && [], b = [], w = l, C = e || u && r.find.TAG("*", c), S = T += null == w ? 1 : Math.random() || .1, E = C.length;
            ...
            w.extend({
                ...
                ajax: function(t, n) {
                    "object" == typeof t && (n = t,
                        t = void 0),
                        n = n || {};
                    var r, i, o, a, s, u, l, c, f, p, d = w.ajaxSetup({}, n), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? w(h) : w.event, y = w.Deferred(), m = w.Callbacks("once memory"), x = d.statusCode || {}, b = {}, T = {}, C = "canceled", S = {
                        readyState: 0,
                    ...
                    for (f in (c = w.event && d.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                        ...
                        d.data && (d.processData || "string" == typeof d.data) && (i += (St.test(i) ? "&" : "?") + d.data,
                            delete d.data),
                        !1 === d.cache && (i = i.replace(Lt, "$1"),
                            p = (St.test(i) ? "&" : "?") + "_=" + Ct.guid++ + p),
                            d.url = i + p),
                    d.ifModified && (w.lastModified[i] && S.setRequestHeader("If-Modified-Since", w.lastModified[i]),
                    ...
                    function E(t, n, a, u) {
                        ...
                        !f && -1 < w.inArray("script", d.dataTypes) && w.inArray("json", d.dataTypes) < 0 && (d.converters["text script"] = function() {}
                            ...
                            f ? (d.ifModified && ((T = S.getResponseHeader("Last-Modified")) && (w.lastModified[i] = T),
            ...
            w.ajaxPrefilter("json jsonp", (function(t, n, r) {
                    ...
                    if (s || "jsonp" === t.dataTypes[0])
                        return i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                            s ? t[s] = t[s].replace(Vt, "$1" + i) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
